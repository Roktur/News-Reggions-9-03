...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] flex flex-col md:flex-row">
      ...
      {/* Sidebar / Input Area */}
      <div className="w-full md:w-1/3 lg:w-1/4 bg-[#222222] border-r border-[#333333] p-6 pb-0 flex flex-col shadow-lg z-10 h-screen md:h-auto overflow-y-auto">
        ...
        <div className="mt-8 pt-4 pb-6 border-t border-[#333333] text-xs text-slate-500 text-center">
